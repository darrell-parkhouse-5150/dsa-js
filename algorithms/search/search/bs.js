...
function ZoomShowSearchBox()
{
    ...
    document.writeln(" <input type=\"text\" name=\"zoom_query\" size=\"20\" value=\"" + htmlspecialchars(query) + "\" id=\"zoom_searchbox\" placeholder='" + STR_FORM_SEARCHFOR + "' class=\"zoom_searchbox\" />");
}

function ZoomShowSearchButton()
{
    document.writeln("<input type=\"submit\" value=\"" + STR_FORM_SUBMIT_BUTTON + "\" class=\"zoom_button btn-primary\" />");
}
...
{
    // document.writeln("<div class='mt-10'><span class=\"zoom_match\">" + STR_FORM_MATCH + " ");
    document.writeln("<div class='mt-10'><span class=\"zoom_match\">");
    if (andq == 0) {
...
function ZoomShowFormEnd()
{
    ...
    if(getParam("zoom_query") == ""){
        ...
        document.writeln("</form>" +
            "</div></div>" +
            "<div class=\"box white shadow box-normal\"><div class=\"content\">");
    }
}
...
function ZoomShowSummary()
{
    ...
    if (SkippedWords > 0)
        document.writeln("<div class=\"summary pb-10\">" + STR_SKIPPED_FOLLOWING_WORDS + " " + SkippedOutputStr + ".<br /><br /></div>");

    //Display search result information
    document.writeln("<div class=\"summary pb-10\">");
    if (matches == 0)
...
function ZoomShowPageNumbers()
{
    ...
    if (num_pages > 1)
    {
        ...
        // document.writeln("<div class=\"result_pages mt-20\">" + STR_RESULT_PAGES + " ");
        document.writeln("<br><div class=\"result_pages\">" + " ");
        if (page > 1)
